...
def columns(*, return_data_as="", output_file="", sort_by="", debug=False, **filter_arguments):
    ...
    if debug != True and debug != False:
        print(
            f"columns(): ERROR: The `debug` parameter must be set to True or False; you specified '{debug}', which is neither.",
            file=sys.stderr,
        )
    ...
    if return_data_as not in allowed_return_types:
        ...
        print(
            f"columns(): ERROR: 'output_file' was specified, but this is only meaningful if 'return_data_as' is set to 'tsv'. You requested return_data_as='{return_data_as}'.",
            file=sys.stderr,
        )
        print(
    ...
    if debug == True:
        ...
        print("BEGIN DEBUG MESSAGE: columns(): Processed sort directives", file=sys.stderr)
        ...
        print("END   DEBUG MESSAGE: columns(): Processed sort directives", file=sys.stderr)
    ...
    if debug == True:
        ...
        print("BEGIN DEBUG MESSAGE: columns(): Processed filter directives; summary", file=sys.stderr)
        ...
        print("END   DEBUG MESSAGE: columns(): Processed filter directives; summary", file=sys.stderr)
    ...
    if url_override is not None and len(url_override) > 0:
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: columns(): Loaded CDA_API_URL from environment", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: columns(): Loaded CDA_API_URL from environment", file=sys.stderr)
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: columns(): Loaded CDA API URL from default config", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: columns(): Loaded CDA API URL from default config", file=sys.stderr)
    ...
    if debug == True:
        ...
        print("BEGIN DEBUG MESSAGE: columns(): Querying CDA API 'columns' endpoint", file=sys.stderr)
    ...
    if isinstance(columns_response_data_object, ApplyResult):
        ...
        try:
            ...
            if re.search("urllib3.exceptions.MaxRetryError", str(type(e))) is not None:
                ...
                print(
                    f"columns(): ERROR: Something ({type(e)}) went wrong when trying to connect to the API. Please check settings (rerunning the last call with debug=True will give more information).",
                    file=sys.stderr,
                )
    ...
    if debug == True:
        print(
            f"Query complete: initial (unfiltered) result set contains records describing { len( columns_response_data_object['result'] ) } columns.",
            end="\n\n",
            file=sys.stderr,
        )
        ...
        print("END   DEBUG MESSAGE: columns(): Queried CDA API 'columns' endpoint", file=sys.stderr)
    ...
    result_dataframe = pd.DataFrame.from_records(
        columns_response_data_object["result"], columns=["endpoint", "fieldName", "type", "isNullable", "description"]
    )
    ...
    if return_data_as == "":
        ...
        if debug == True:
            ...
            print(
                "      DEBUG MESSAGE: columns(): Returning results in default form (pandas.DataFrame)", file=sys.stderr
            )
...
def column_values(
    ...
    if debug != True and debug != False:
        print(
            f"column_values(): ERROR: The `debug` parameter must be set to True or False; you specified '{debug}', which is neither.",
            file=sys.stderr,
        )
    ...
    if force != True and force != False:
        print(
            f"column_values(): ERROR: The `force` parameter must be set to True or False; you specified '{force}', which is neither.",
            file=sys.stderr,
        )
    ...
    if not isinstance(sort_by, str):
        ...
        print(
            f"column_values(): ERROR: 'sort_by' must be a string; you used '{sort_by}', which is not.", file=sys.stderr
        )
    ...
    if debug == True:
        ...
        print("END   DEBUG MESSAGE: column_values(): Processed sort directives", file=sys.stderr)
    ...
    if url_override is not None and len(url_override) > 0:
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: column_values(): Loaded CDA_API_URL from environment", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: column_values(): Loaded CDA_API_URL from environment", file=sys.stderr)
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: column_values(): Loaded CDA API URL from default config", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: column_values(): Loaded CDA API URL from default config", file=sys.stderr)
    ...
    if debug == True:
        ...
        print("BEGIN DEBUG MESSAGE: column_values(): Querying CDA API 'unique_values' endpoint", file=sys.stderr)
    ...
    if isinstance(paged_response_data_object, ApplyResult):
        ...
        try:
            ...
            if re.search("urllib3.exceptions.MaxRetryError", str(type(e))) is not None:
                ...
                print(
                    f"column_values(): ERROR: Something ({type(e)}) went wrong when trying to connect to the API. Please check settings (rerunning the last call with debug=True will give more information).",
                    file=sys.stderr,
                )
    ...
    if debug == True and paged_response_data_object["next_url"] is not None:
        print("Fetching remaining results in pages...", file=sys.stderr)
    ...
    if sort_by == "count":
        ...
        print("column_values(): ERROR: something has gone horribly wrong; we should never get here.", file=sys.stderr)
    ...
    if return_data_as == "":
        ...
        if debug == True:
            ...
            print(
                "      DEBUG MESSAGE: column_values(): Returning results in default form (pandas.DataFrame)",
                file=sys.stderr,
            )
        ...
        if debug == True:
            ...
            print(
                f"      DEBUG MESSAGE: column_values(): Printing results to TSV file '{output_file}'", file=sys.stderr
            )
...
def summary_counts(
    ...
    *,
    ...
    if debug != True and debug != False:
        print(
            f"summary_counts(): ERROR: The `debug` parameter must be set to True or False; you specified '{debug}', which is neither.",
            file=sys.stderr,
        )
    ...
    if not isinstance(table, str) or table == "":
        print(
            f"summary_counts(): ERROR: parameter 'table' is required and must be a nonempty string; you supplied '{table}', which is not.",
            file=sys.stderr,
        )
    ...
    if table not in valid_tables:
        print(
            f"summary_counts(): ERROR: parameter 'table' must be a searchable CDA table; you supplied '{table}', which is not.",
            file=sys.stderr,
        )
    ...
    if not isinstance(return_data_as, str):
        print(
            f"summary_counts(): ERROR: unrecognized return type '{return_data_as}' requested. Please use one of 'dataframe_list', 'dict' or 'json' (or omit the 'return_data_as' parameter altogether).",
            file=sys.stderr,
        )
    ...
    if not isinstance(output_file, str):
        print(
            f"summary_counts(): ERROR: the `output_file` parameter, if not omitted, should be a string containing a path to the desired output file. You supplied '{output_file}', which is not a string, let alone a valid path.",
            file=sys.stderr,
        )
    ...
    if return_data_as not in allowed_return_types:
        ...
        print(
            "summary_counts(): ERROR: return type 'json' requested, but 'output_file' not specified. Please specify output_file='some/path/string/to/write/your/json/to'.",
            file=sys.stderr,
        )
        ...
        print(
            f"summary_counts(): ERROR: 'output_file' was specified, but this is only meaningful if 'return_data_as' is set to 'json'. You requested return_data_as='{return_data_as}'.",
            file=sys.stderr,
        )
        print(
    ...
    if not isinstance(match_all, list):
        print(
            f"summary_counts(): ERROR: value assigned to 'match_all' parameter must be a filter string or a list of filter strings; you specified '{match_all}', which is neither.",
            file=sys.stderr,
        )
    ...
    for item in match_all:
        if not isinstance(item, str) or len(item) == 0:
            print(
                f"summary_counts(): ERROR: value assigned to 'match_all' parameter must be a nonempty filter string or a list of nonempty filter strings; you specified '{match_all}', which is neither.",
                file=sys.stderr,
            )
        ...
        if re.search(r"^\S+\s+\S+\s+\S.*$", item) is None:
            print(
                f"summary_counts(): ERROR: match_all: filter string '{item}' does not conform to 'COLUMN_NAME OP VALUE' format.",
                file=sys.stderr,
            )
    ...
    if not isinstance(match_any, list):
        print(
            f"summary_counts(): ERROR: value assigned to 'match_any' parameter must be a filter string or a list of filter strings; you specified '{match_any}', which is neither.",
            file=sys.stderr,
        )
    ...
    for item in match_any:
        if not isinstance(item, str) or len(item) == 0:
            print(
                f"summary_counts(): ERROR: value assigned to 'match_any' parameter must be a nonempty filter string or a list of nonempty filter strings; you specified '{match_any}', which is neither.",
                file=sys.stderr,
            )
        ...
        if re.search(r"^\S+\s+\S+\s+\S.*$", item) is None:
            print(
                f"summary_counts(): ERROR: match_any: filter string '{item}' does not conform to 'COLUMN_NAME OP VALUE' format.",
                file=sys.stderr,
            )
    ...
    if not isinstance(match_from_file, dict):
        print(
            f"summary_counts(): ERROR: value assigned to 'match_from_file' parameter must be a 3-element dictionary with keys ['input_file', 'input_column', 'cda_column_to_match']; you specified '{match_from_file}', which is not.",
            file=sys.stderr,
        )
    ...
    if match_from_file_target_column == "":
        if match_from_file["input_file"] != "" or match_from_file["input_column"] != "":
            print(
                f"summary_counts(): ERROR: if the 'match_from_file' parameter is used, it must be a 3-element dictionary with keys ['input_file', 'input_column', 'cda_column_to_match'] pointing to non-empty values. You specified '{match_from_file}', which is not that.",
                file=sys.stderr,
            )
        ...
        if len(columns(column=match_from_file_target_column, return_data_as="list")) == 0:
            print(
                f"summary_counts(): ERROR: CDA column '{match_from_file_target_column}' (specified in your 'match_from_file' parameter) does not exist. Please see the output of columns() for a list of those that do.",
                file=sys.stderr,
            )
        ...
        if match_from_file_input_file == output_file:
            print(
                f"summary_counts(): ERROR: You specified the same file ('{output_file}') as both a source of filter values (via 'match_from_file') and the target output file ( via 'output_file'). Please make sure these two files are different.",
                file=sys.stderr,
            )
        ...
        try:
            with open(match_from_file_input_file) as IN:
                ...
                if match_from_file_source_column_name not in column_names:
                    print(
                        f"summary_counts(): ERROR: TSV column '{match_from_file_source_column_name}' (specified in your 'match_from_file' parameter) does not exist. Columns in your specified input file ('{match_from_file_input_file}') are:\n\n    {column_names}\n",
                        file=sys.stderr,
                    )
            ...
            print(
                f"summary_counts(): ERROR: Couldn't load requested column '{match_from_file_source_column_name}' from requested TSV file '{match_from_file_input_file}': got error of type '{type(error)}', with error message '{error}'.",
                file=sys.stderr,
            )
    ...
    if isinstance(data_source, str):
        ...
        print(
            f"summary_counts(): ERROR: value assigned to the 'data_source' parameter must be a string (e.g. 'GDC') or a list of strings (e.g. [ 'GDC', 'CDS' ]); you specified '{data_source}', which is neither.",
            file=sys.stderr,
        )
    ...
    for item in data_source:
        if not isinstance(item, str) or len(item) == 0:
            print(
                f"summary_counts(): ERROR: value assigned to the 'data_source' parameter must be a nonempty string (e.g. 'GDC') or a list of strings (e.g. [ 'GDC', 'CDS' ]); you specified '{data_source}', which is neither.",
                file=sys.stderr,
            )
    ...
    for item in data_source:
        if item not in allowed_data_source_values:
            print(
                f"summary_counts(): ERROR: values assigned to the 'data_source' parameter must be one of { 'GDC', 'PDC', 'IDC', 'CDS', 'ICDC' }. You supplied '{item}', which is not.",
                file=sys.stderr,
            )
    ...
    for item in match_all:
        ...
        if matching_column_count != 1:
            print(
                f"summary_counts(): ERROR: match_all: requested column '{filter_column_name}' is not a searchable CDA column.",
                file=sys.stderr,
            )
        ...
        if filter_operator == "==":
            ...
            print(
                f"summary_counts(): ERROR: match_all: operator '{filter_operator}' is not supported.", file=sys.stderr
            )
        ...
        if filter_operator not in operators_by_data_type[target_data_type]:
            print(
                f"summary_counts(): ERROR: match_all: operator '{filter_operator}' is not usable for values of type '{target_data_type}'.",
                file=sys.stderr,
            )
        ...
        if filter_value.lower() != "null":
            if target_data_type == "boolean":
                ...
                if filter_value not in boolean_alias:
                    print(
                        f"summary_counts(): ERROR: match_all: requested column {filter_column_name} has data type 'boolean', requiring a true/false value; you specified '{filter_value}', which is neither.",
                        file=sys.stderr,
                    )
                ...
                if re.search(r"^[-+]?\d+(\.\d+)?$", filter_value) is None:
                    print(
                        f"summary_counts(): ERROR: match_all: requested column {filter_column_name} has data type '{target_data_type}', requiring a number value; you specified '{filter_value}', which is not.",
                        file=sys.stderr,
                    )
                ...
                if re.search(r"\*", filter_value) is not None:
                    print(
                        f"summary_counts(): ERROR: match_all: wildcards (*) are only allowed at the ends of string values; string '{original_filter_value}' is noncompliant (it has one in the middle). Please fix.",
                        file=sys.stderr,
                    )
                ...
                print(
                    f"summary_counts(): ERROR: match_all: unanticipated `target_data_type` '{target_data_type}', cannot continue. Please report this event to CDA developers.",
                    file=sys.stderr,
                )
        ...
        if filter_value.lower() == "null":
            if filter_operator == "=":
                ...
                print(
                    f"summary_counts(): ERROR: match_all: filter query '{filter_column_name} {filter_operator} {filter_value}' is malformed: please use only = and != when filtering on NULL.",
                    file=sys.stderr,
                )
    ...
    for item in match_any:
        ...
        if matching_column_count != 1:
            print(
                f"summary_counts(): ERROR: match_any: requested column '{filter_column_name}' is not a searchable CDA column.",
                file=sys.stderr,
            )
        ...
        if filter_operator == "==":
            ...
            print(
                f"summary_counts(): ERROR: match_any: operator '{filter_operator}' is not supported.", file=sys.stderr
            )
        ...
        if filter_operator not in operators_by_data_type[target_data_type]:
            print(
                f"summary_counts(): ERROR: match_any: operator '{filter_operator}' is not usable for values of type '{target_data_type}'.",
                file=sys.stderr,
            )
        ...
        if filter_value.lower() != "null":
            if target_data_type == "boolean":
                ...
                if filter_value not in boolean_alias:
                    print(
                        f"summary_counts(): ERROR: match_any: requested column {filter_column_name} has data type 'boolean', requiring a true/false value; you specified '{filter_value}', which is neither.",
                        file=sys.stderr,
                    )
                ...
                if re.search(r"^[-+]?\d+(\.\d+)?$", filter_value) is None:
                    print(
                        f"summary_counts(): ERROR: match_any: requested column {filter_column_name} has data type '{target_data_type}', requiring a number value; you specified '{filter_value}', which is not.",
                        file=sys.stderr,
                    )
                ...
                if re.search(r"\*", filter_value) is not None:
                    print(
                        f"summary_counts(): ERROR: match_any: wildcards (*) are only allowed at the ends of string values; string '{original_filter_value}' is noncompliant (it has one in the middle). Please fix.",
                        file=sys.stderr,
                    )
                ...
                print(
                    f"summary_counts(): ERROR: match_any: unanticipated `target_data_type` '{target_data_type}', cannot continue. Please report this event to CDA developers.",
                    file=sys.stderr,
                )
        ...
        if filter_value.lower() == "null":
            if filter_operator == "=":
                ...
                print(
                    f"summary_counts(): ERROR: match_any: filter query '{filter_column_name} {filter_operator} {filter_value}' is malformed: please use only = and != when filtering on NULL.",
                    file=sys.stderr,
                )
    ...
    for target_value in match_from_file_target_values:
        ...
        if target_data_type == "boolean":
            ...
            if target_value not in boolean_alias:
                print(
                    f"summary_counts(): ERROR: match_from_file: requested column {match_from_file_target_column} has data type 'boolean', requiring a true/false value; you specified '{target_value}', which is neither.",
                    file=sys.stderr,
                )
            ...
            if re.search(r"^[-+]?\d+(\.\d+)?$", target_value) is None:
                print(
                    f"summary_counts(): ERROR: match_from_file: requested column {match_from_file_target_column} has data type '{target_data_type}', requiring a number value; you specified '{target_value}', which is not.",
                    file=sys.stderr,
                )
            ...
            if re.search(r"\*", target_value) is not None:
                print(
                    f"summary_counts(): ERROR: match_from_file: wildcards (*) are disallowed here (only exact matches are supported for this option); string '{target_value}' is noncompliant. Please fix.",
                    file=sys.stderr,
                )
            ...
            print(
                f"summary_counts(): ERROR: match_from_file: unanticipated `target_data_type` '{target_data_type}', cannot continue. Please report this event to CDA developers.",
                file=sys.stderr,
            )
    ...
    if url_override is not None and len(url_override) > 0:
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: summary_counts(): Loaded CDA_API_URL from environment", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: summary_counts(): Loaded CDA_API_URL from environment", file=sys.stderr)
        ...
        if debug == True:
            ...
            print("BEGIN DEBUG MESSAGE: summary_counts(): Loaded CDA API URL from default config", file=sys.stderr)
            ...
            print("END  DEBUG MESSAGE: summary_counts(): Loaded CDA API URL from default config", file=sys.stderr)
    ...
    paged_response_data_object = query_selector[table](query=final_query, dry_run=False, async_req=True)
    ...
    if isinstance(paged_response_data_object, ApplyResult):
        ...
        try:
            ...
            if re.search("urllib3.exceptions.MaxRetryError", str(type(e))) is not None:
                ...
                print(
                    f"summary_counts(): ERROR: Something ({type(e)}) went wrong when trying to connect to the API. Please check settings (rerunning the last call with debug=True will give more information).",
                    file=sys.stderr,
                )
    ...
    if debug == True:
        ...
        print(
            f"BEGIN DEBUG MESSAGE: summary_counts(): First page of '{table}/counts' endpoint response", file=sys.stderr
        )
    ...
    if return_data_as == "" or return_data_as == "dataframe_list":
        ...
        for result_column in result_dataframe.columns:
            if result_column not in [f"total_{table}_matches", "total_related_files"]:
                ...
                if result_dataframe[result_column].dtype == "object":
                    ...
                    print(
                        f"summary_counts(): ERROR: unexpected return type '{result_dataframe[result_column].dtype}' observed in result column '{result_column}'; please inform the CDA devs of this event.",
                        file=sys.stderr,
                    )
        ...
        if return_data_as == "":
            if debug == True:
                ...
                print(
                    "      DEBUG MESSAGE: summary_counts(): Returning results in default form (printing list of tables to standard output)",
                    file=sys.stderr,
                )
            ...
            if debug == True:
                ...
                print(
                    "      DEBUG MESSAGE: summary_counts(): Returning results as a list of pandas.DataFrame objects",
                    file=sys.stderr,
                )
        ...
        if return_data_as == "dict":
            if debug == True:
                ...
                print(
                    "      DEBUG MESSAGE: summary_counts(): Returning results as a Python dictionary", file=sys.stderr
                )
            ...
            if debug == True:
                ...
                print(
                    f"      DEBUG MESSAGE: summary_counts(): Printing results to JSON file '{output_file}'",
                    file=sys.stderr,
                )
            ...
            try:
                ...
                print(
                    f"summary_counts(): ERROR: Couldn't write to requested output file '{output_file}': got error of type '{type(error)}', with error message '{error}'.",
                    file=sys.stderr,
                )
    ...
    print(
        "summary_counts(): ERROR: Something has gone unexpectedly and disastrously wrong with return-data postprocessing. Please alert the CDA devs to this event and include details of how to reproduce this error.",
        file=sys.stderr,
    )
